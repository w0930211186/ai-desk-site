...
預計跑在 Netlify 假設網址 `ai-desk-tw.netlify.app`（實際網址以 Netlify 分配為準）
...
5. 最終網址會是 `https://ai-desk-tw.netlify.app`
...
1. 決定網址（`ai-desk-tw.netlify.app` / `ai-column.netlify.app` / 買獨立域名）
